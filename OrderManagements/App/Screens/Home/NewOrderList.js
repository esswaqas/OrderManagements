...
var listsss = useSelector(state => state.auth.NewOreder);
...
<ListItem.Content>
<ListItem.Title style={{fontSize:15}}>{item.customer.first_Name} {item.customer.last_Name} {item.id}</ListItem.Title>
